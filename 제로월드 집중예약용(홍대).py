...
def get_csrf_token(session):
    response = session.get('https://www.zerohongdae.com/reservation')
...
def send_post_request(session, csrf_token, reservation_data):
    ...
    response = session.post('https://www.zerohongdae.com/reservation', json=reservation_data, headers=headers)
    return response
