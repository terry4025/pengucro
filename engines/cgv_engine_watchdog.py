...
class CgvEngine(RuntimeCgvEngine):
    ...
    * a 401 receives one soft same-tab refresh/retry.  If CGV really requires a
    ...
    def log(self, message: str, level: str = "info") -> None:
        # These are the two state transitions emitted by the mature base loop.
        # Track them before the parent runtime rewrites the old human-readable
        # cadence text using this subclass's current constants.
